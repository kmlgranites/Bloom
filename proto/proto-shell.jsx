...
function PFrame({ children, url = "bloom.app" }) {
  return (
    <div style={{
      ...
      borderRadius: 18, overflow: "hidden", background: pT.cream,
      ...
      <div style={{
        height: 40, background: "rgba(255,255,255,0.7)", borderBottom: `1px solid ${pT.hairline}`,
        ...
        <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
          <div style={{ background: "rgba(0,0,0,0.05)", borderRadius: 999, padding: "4px 14px", fontSize: 12, color: pT.inkSoft, fontWeight: 600, display: "flex", alignItems: "center", gap: 6 }}>
            🔒 {url}
          </div>
        </div>
        <div style={{ width: 60 }} />
      ...
      <div style={{
        ...
        <div style={{ background: pT.ink, color: "#fff", borderRadius: 16, padding: 12, marginTop: 12, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, position: "relative", marginBottom: 8 }}>
            <img src="assets/bloom-avatar.svg" alt="Sprout" style={{ width: 30, height: "auto", display: "block", flexShrink: 0 }} />
