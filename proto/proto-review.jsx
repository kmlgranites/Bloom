  ...
  return (
    <div style={{flex:1, display:"flex", flexDirection:"column", overflow:"hidden", minHeight: 0}}>
      ...
      <div style={{flex:1, display:"flex", minHeight: 0, background: rT.cream}}>
        {/* Left context rail — calm role facts */}
        <div style={{width: 300, flexShrink: 0, background:"#fff", borderRight:`1px solid ${rT.hairline}`, padding:"24px", overflow:"auto"}}>
          <div style={{fontSize: 11.5, color: rT.muted, fontWeight: 600, marginBottom: 4}}>🌱 Drafted by Sprout · just now</div>
          <div style={{fontSize: 11.5, color: rT.muted, fontWeight: 600, marginBottom: 18}}>Matched to your <b style={{color: rT.cyanInk}}>{job.role}</b> search</div>

          <div style={{fontSize: 10.5, fontWeight: 800, color: rT.muted, letterSpacing:"0.06em", textTransform:"uppercase", marginBottom: 6}}>Job title</div>
          <div style={{fontFamily: rFD, fontWeight: 700, fontSize: 21, color: rT.ink, letterSpacing:"-0.02em", lineHeight: 1.15, marginBottom: 18}}>{job.role}</div>
          ...
          <div style={{display:"flex", flexDirection:"column", gap: 11, marginBottom: 18}}>
            {[
              ...
              <div key={k} style={{display:"flex", alignItems:"center", gap: 10, fontSize: 13}}>
                ...
                <span style={{color: rT.muted, fontWeight: 600, width: 82, flexShrink: 0}}>{k}</span>
                <span style={{fontWeight: 700, color: rT.ink}}>{v}</span>
              </div>
            ))}
          </div>

          <div style={{height: 1, background: rT.hairline, margin:"0 0 16px"}}/>
          <div style={{fontSize: 10.5, fontWeight: 800, color: rT.muted, letterSpacing:"0.06em", textTransform:"uppercase", marginBottom: 8}}>Sending with</div>
          <div style={{display:"inline-flex", alignItems:"center", gap: 8, padding:"8px 12px", borderRadius: 10, background: rT.cream, fontSize: 12.5, fontWeight: 700, color: rT.ink}}>📄 Vinodh_Resume_2026.pdf</div>
        </div>
        ...
        <div style={{flex:1, overflow:"auto", padding:"28px 0", display:"flex", justifyContent:"center"}}>
          <div style={{width:"100%", maxWidth: 720, display:"flex", flexDirection:"column", gap: 12, padding:"0 36px"}}>
            ...
            <div style={{background: rT.lilac, borderRadius: 16, padding:"16px 18px", display:"flex", alignItems:"center", gap: 14}}>
              <RA size={36} cap={rT.cyan} mood="happy"/>
              <div style={{flex:1}}>
            ...
            <button onClick={()=>d({type:"APPROVE_JOB", jobId: job.id})} style={{marginTop: 6, padding:"15px 24px", borderRadius: 14, background: rT.ink, color:"#fff", fontSize: 15, fontWeight: 700, border:"none", cursor:"pointer", width:"100%"}}>
...
function PageSubmitted() {
  ...
  return (
    <div style={{flex:1, display:"flex", flexDirection:"column", overflow:"hidden"}}>
      ...
      <div style={{flex:1, display:"flex", minHeight: 0, background: rT.cream}}>
        {/* Left context rail — calm, just the role facts */}
        <div style={{width: 300, flexShrink: 0, background:"#fff", borderRight:`1px solid ${rT.hairline}`, padding:"24px", overflow:"auto"}}>
          <div style={{fontSize: 11.5, color: rT.muted, fontWeight: 600, marginBottom: 4}}>🕘 Submitted {job.appliedAt}</div>
          <div style={{fontSize: 11.5, color: rT.muted, fontWeight: 600, marginBottom: 18}}>Selected by <b style={{color: rT.cyanInk}}>Sprout · {job.role}</b></div>
          ...
          <div style={{height: 1, background: rT.hairline, margin:"0 0 16px"}}/>
          <div style={{fontSize: 10.5, fontWeight: 800, color: rT.muted, letterSpacing:"0.06em", textTransform:"uppercase", marginBottom: 8}}>Sent with</div>
          <div style={{display:"inline-flex", alignItems:"center", gap: 8, padding:"8px 12px", borderRadius: 10, background: rT.cream, fontSize: 12.5, fontWeight: 700, color: rT.ink}}>📄 Vinodh_Resume_2026.pdf</div>
        </div>
